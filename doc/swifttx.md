...
This mechanism has been integrated into Bitcore-Node-BS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cevap/insight-api-BS#web-socket-api](https://github.com/cevap/insight-api-BS#web-socket-api) 
* API: [https://github.com/cevap/insight-api-BS#swifttx-transactions](https://github.com/cevap/insight-api-BS#swifttx-transactions) 
...
By default, the BS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BS Core daemon:
