...
In order to support loading of multiple wallets in BS-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BS.cpp.
...
Changes to BS.cpp
----------------------
BS.cpp is the entry point into BS-qt, and as such, will require some minor modifications to provide hooks for
