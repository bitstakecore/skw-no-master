Contributing to BS Core
============================

The BS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BS Core project, and is not to be
confused with overall BS Network Protocol consensus changes.

Whether a pull request is merged into BS Core rests with the project merge
...
Patches that change BS consensus rules are considerably more involved than
...
Where a patch set proposes to change the BS consensus, it must have been
...
The project leader is the release manager for each BS Core release.
