...
/* BS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BS"
#define QAPP_ORG_DOMAIN "BS-coin.com"
#define QAPP_APP_NAME_DEFAULT "BS-Qt"
#define QAPP_APP_NAME_TESTNET "BS-Qt-testnet"
