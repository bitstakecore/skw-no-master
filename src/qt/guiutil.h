...
/** Utility functions used by the BS Qt UI.
 */
namespace GUIUtil
{
...
// Render BS addresses in monospace font
...
// Parse "BS:" URI into recipient object, return true on successful parsing
