                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SKW Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SKW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SKW: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SKW Core"), this);
    aboutAction->setStatusTip(tr("Show information about SKW Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SKW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SKW addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SKW Core help message to get a list with possible SKW command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SKW Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SKW network", "", count));
}
...
{
    QString strTitle = tr("SKW Core"); // default title
