...
#   c) node1 mines 32 blocks, so now node 0 has 60001BS, node 1 has 4250BS, node2 has none.
#   d) node0 sends 601 BS to node2, in two transactions (301 BS, then 300 BS).
