...
###   This script attempts to download the signature file SHA256SUMS.asc from bitstake.xyz
...
SIGNATUREFILE="https://bitstake.xyz/bin/3.0.4.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://bitstake.xyz/bin/"
